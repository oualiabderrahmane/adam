...
public class Personne {
    ...
    public boolean estClient(ListeClients listeClients, String nomAgent) {
        boolean existe = listeClients.contient(this);
        if (existe) {
            System.out.println("- La personne \"" + nom + "\" est déjà un client de l'agent \"" + nomAgent + "\".");
        }
        return existe;
    }
